...
public class FEN {
    ...
    public static String createFEN(ChessEngine engine){
        ...
        FENString = FENString.concat(FENString);
        FENString = FENString.concat(rightsToCastle(engine));
        FENString = FENString.concat(getEnPassantTile(engine));

        FENString = FENString.concat(getHalfMove(engine));
        FENString = FENString.concat(getFullMove(engine));

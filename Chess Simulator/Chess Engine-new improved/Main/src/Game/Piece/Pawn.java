...
public class Pawn extends Piece {
    ...
    private boolean pawnOnePush(int col, int row){
    ...
    private boolean pawnTwoPush(int col, int row){
        boolean isSameColumn = (this.col == col);
    ...
    private boolean pawnCapture(int col, int row){
    ...
    private boolean pawnEnPassant(int col, int row){

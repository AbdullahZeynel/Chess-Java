...
public class Variables {
    ...
    /// URL to the pieces sprite sheet, resolved from the classpath.
    /// Gradle places src/main/resources/ on the classpath automatically.
    public static java.net.URL piecesResourceUrl = null;

    static {
        // Load pieces.png from the classpath (src/main/resources/pieces.png)
        piecesResourceUrl = Variables.class.getClassLoader().getResource("pieces.png");

        if (piecesResourceUrl == null) {
            System.err.println("ERROR: pieces.png not found on classpath!");
        }
